...
typedef  struct _IEEEtypes_VendorHeader_t
{
    ...
    /** Version */
    t_u8 version;
}  IEEEtypes_VendorHeader_t, *pIEEEtypes_VendorHeader_t;
...
}  IEEEtypes_VendorSpecific_t, *pIEEEtypes_VendorSpecific_t;
...
typedef  struct _IEEEtypes_FtCapPolicy_t
{
    ...
    /** Reserved */
    t_u8 reserved : 6;
}  IEEEtypes_FtCapPolicy_t;

/** Mobility domain IE */
typedef  struct _IEEEtypes_MobilityDomain_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** Mobility Domain ID */
...
/**FT MIC Control*/
typedef  struct _IEEEtypes_FT_MICControl_t
{
    /** reserved */
    t_u8 reserved;
    /** element count */
    t_u8 element_count;
}  IEEEtypes_FT_MICControl_t;

/** FTIE MIC LEN */
#define FTIE_MIC_LEN 16

/**FT IE*/
typedef  struct _IEEEtypes_FastBssTransElement_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** mic control */
    ...
    /** sub element */
    t_u8 sub_element[1];
}  IEEEtypes_FastBssTransElement_t;
...
} PACK_START  IEEEtypes_CapInfo_t, *pIEEEtypes_CapInfo_t;

/** IEEEtypes_Ssid_t */
typedef  struct _IEEEtypes_Ssid_t
{
    /** SSID: Element ID */
    t_u8 element_id;
    /** SSID : Length */
...
}  IEEEtypes_Ssid_t, *pIEEEtypes_Ssid_t;
...
}  IEEEtypes_CfParamSet_t, *pIEEEtypes_CfParamSet_t;
...
typedef  struct _IEEEtypes_FhParamSet_t
{
    ...
    t_u8 hop_index;
}  IEEEtypes_FhParamSet_t, *pIEEEtypes_FhParamSet_t;
...
typedef  struct _IEEEtypes_DsParamSet_t
{
    ...
    t_u8 current_chan;
}  IEEEtypes_DsParamSet_t, *pIEEEtypes_DsParamSet_t;

/** IEEEtypes_DTIMParamSet_t */
typedef  struct _IEEEtypes_DtimParamSet_t
{
    /** Element ID */
    IEEEtypes_ElementId_e element_id;
    /** Length */
...
}  IEEEtypes_DtimParamSet_t, *pIEEEtypes_DtimParamSet_t;
...
typedef  struct _IEEEtypes_ERPInfo_t
{
    ...
    /** ERP flags */
    t_u8 erp_flags;
}  IEEEtypes_ERPInfo_t, *pIEEEtypes_ERPInfo_t;
...
typedef  enum _IEEEtypes_StatusCode_e
{
...
/** IEEEtypes_SeqCtl_t */
typedef  struct _IEEEtypes_SeqCtl_t
{
    /** Fragment Number */
    t_u16 FragNum : 4;
    /** Sequence Number */
...
/** IEEEtypes_MgmtHdr_t */
typedef  struct _IEEEtypes_MgmtHdr_t
{
    /** FrmCtl*/
    t_u16 FrmCtl;
    /** Duration*/
...
typedef  struct _IEEEtypes_AssocRsp_t
{
    ...
    /** IE data buffer */
    t_u8 ie_buffer[1];
}  IEEEtypes_AssocRsp_t, *pIEEEtypes_AssocRsp_t;
...
/** IEEEtypes_Rsn_t */
typedef  struct _IEEEtypes_Rsn_t
{
    /** Rsn : Element ID */
    IEEEtypes_ElementId_e element_id;
    /** Rsn : Length */
...
/** IEEEtypes_Rsnx_t */
typedef  struct _IEEEtypes_Rsnx_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** Rsnx : data */
    t_u8 data[1];
}  IEEEtypes_Rsnx_t, *pIEEEtypes_Rsnx_t;

/** IEEEtypes_Wpa_t */
typedef  struct _IEEEtypes_Wpa_t
{
    /** Wpa : Element ID */
    IEEEtypes_ElementId_e element_id;
    /** Wpa : Length */
    ...
    /** Wpa : AuthKey Mgmt */
    // wpa_suite_auth_key_mgmt_t auth_key_mgmt;
}  IEEEtypes_Wpa_t, *pIEEEtypes_Wpa_t;
...
typedef  struct _IEEEtypes_WmmAciAifsn_t
{
    ...
    /** Reserved */
    t_u8 reserved : 1;
}  IEEEtypes_WmmAciAifsn_t, *pIEEEtypes_WmmAciAifsn_t;
...
typedef  struct _IEEEtypes_WmmEcw_t
{
    ...
    /** Maximum Ecw */
    t_u8 ecw_max : 4;
}  IEEEtypes_WmmEcw_t, *pIEEEtypes_WmmEcw_t;
...
}  IEEEtypes_WmmAcParameters_t, *pIEEEtypes_WmmAcParameters_t;
...
}  IEEEtypes_WmmInfo_t, *pIEEEtypes_WmmInfo_t;
...
}  IEEEtypes_WmmParameter_t, *pIEEEtypes_WmmParameter_t;

/** Enumerator for TSPEC direction */
typedef  enum _IEEEtypes_WMM_TSPEC_TS_Info_Direction_e
{
...
typedef  enum _IEEEtypes_WMM_TSPEC_TS_Info_PSB_e
{
...
typedef  enum _IEEEtypes_WMM_TSPEC_TS_Info_AckPolicy_e
{
...
}  IEEEtypes_WMM_TSPEC_TS_Info_AckPolicy_e;

/** Enumerator for TSPEC Trafffice type */
typedef  enum _IEEEtypes_WMM_TSPEC_TS_TRAFFIC_TYPE_e
{

    TSPEC_TRAFFIC_APERIODIC = 0,
    TSPEC_TRAFFIC_PERIODIC  = 1,

}  IEEEtypes_WMM_TSPEC_TS_TRAFFIC_TYPE_e;
...
typedef  struct
{
    ...
    // is nominal
}  IEEEtypes_WMM_TSPEC_NomMSDUSize_t;
...
}  IEEEtypes_WMM_TSPEC_t;

/** WMM Action Category values */
typedef  enum _IEEEtypes_ActionCategory_e
{
...
}  IEEEtypes_ActionCategory_e;

/** IEEE Std 802.11-2016 - Table 9-354 WNM Action field values */
typedef  enum _IEEEtypes_WNM_ActionFieldType_e
{
...
typedef  enum _IEEEtypes_WMM_Tspec_Action_e
{
...
}  IEEEtypes_Action_WMM_AddTsRsp_t;
...
typedef  struct _IEEEtypes_SubbandSet_t
{
    ...
    t_u8 max_tx_pwr;
}  IEEEtypes_SubbandSet_t, *pIEEEtypes_SubbandSet_t;
...
}  IEEEtypes_CountryInfoSet_t, *pIEEEtypes_CountryInfoSet_t;
...
}  IEEEtypes_CountryInfoFullSet_t, *pIEEEtypes_CountryInfoFullSet_t;
...
typedef  struct _IEEEtypes_NotxBssCap_t
{
    ...
    /** capability */
    t_u16 cap;
}  IEEEtypes_NotxBssCap_t, *pIEEEtypes_NotxBssCap_t;

/** Multi BSSID IE */
typedef  struct _IEEEtypes_MultiBSSIDIndex_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** BSSID Index */
    ...
    t_u8 dtim_count;
}  IEEEtypes_MultiBSSIDIndex_t, *pIEEEtypes_MultiBSSIDIndex_t;
...
typedef  struct _IEEEtypes_NonTransBSSIDProfile_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    t_u8 profile_data[];
}  IEEEtypes_NonTransBSSIDProfile_t, *pIEEEtypes_NonTransBSSIDProfile_t;

/** Multi BSSID IE */
typedef  struct _IEEEtypes_MultiBSSID_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** Max BSSID Indicator */
    ...
    t_u8 sub_elem_data[];
}  IEEEtypes_MultiBSSID_t, *pIEEEtypes_MultiBSSID_t;
...
typedef  struct _IEEEtypes_VHTCap_t
{
    ...
    IEEEtypes_Header_t ieee_hdr;
    VHT_capa_t vht_cap;
}  IEEEtypes_VHTCap_t, *pIEEEtypes_VHTCap_t;
...
typedef  struct _IEEEtypes_VHTtxpower_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** maximum tx power */
    ...
    /** channel width */
    t_u8 chan_width;
}  IEEEtypes_VHTtxpower_t, *pIEEEtypes_VHTtxpower_t;

/** Extended Power Constraint IE */
typedef  struct _IEEEtypes_ExtPwerCons_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** channel width */
...
}  IEEEtypes_ExtPwerCons_t, *pIEEEtypes_ExtPwerCons_t;
...
typedef  struct _IEEEtypes_ExtBSSload_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    ...
    /** VHT 160 util */
    t_u8 VHT160_util;
}  IEEEtypes_ExtBSSload_t, *pIEEEtypes_ExtBSSload_t;

/** Quiet Channel IE */
typedef  struct _IEEEtypes_QuietChan_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** AP quiet mode */
    ...
    /** Quiet offset */
    t_u16 quiet_offset;
}  IEEEtypes_QuietChan_t, *pIEEEtypes_QuietChan_t;

/** Wide Bandwidth Channel Switch IE */
typedef  struct _IEEEtypes_BWSwitch_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** New channel width */
...
}  IEEEtypes_BWSwitch_t, *pIEEEtypes_BWSwitch_t;

/** AID IE */
typedef  struct _IEEEtypes_AID_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** AID number */
    t_u16 AID;
}  IEEEtypes_AID_t, *pIEEEtypes_AID_t;

/** Operating Mode Notificaton IE */
typedef  struct _IEEEtypes_OperModeNtf_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** Operating Mode */
    t_u8 oper_mode;
}  IEEEtypes_OperModeNtf_t, *pIEEEtypes_OperModeNtf_t;
...
/** channel statictics */
typedef  struct _ChanStatistics_t
{
    /** channle number */
    t_u8 chan_num;
    /** band info */
...
struct wifi_scan_channel_list_t
{
...
{
    int n_channels;                       // 信道列表的数量
    int n_ssids;                          // SSID 列表的数量
    size_t ie_len;                        // 附加 IE 的长度
    const u8 *ie;                         // 附加的 IE（信息元素）
    struct wifi_scan_channel_list_t channels[32];  // 要扫描的信道列表
    struct cfg80211_ssid ssids[32];          // 要扫描的 SSID 列表
};
...
#endif
#if CONFIG_11AX
typedef  struct _IEEEtypes_Extension_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
...
typedef  struct _IEEEtypes_HeMcsNss_t
{
    /** HE Rx MCS and NSS Set */
    t_u16 rx_mcs;
    /** HE Tx MCS and NSS Set*/
    t_u16 tx_mcs;
}  IEEEtypes_HeMcsNss_t, *pIEEEtypes_HeMcsNss_t;

typedef  struct _IEEEtypes_HECap_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** Element id extension */
...
}  IEEEtypes_HECap_t, *pIEEEtypes_HECap_t;

typedef  struct _IEEEtypes_HeOpParam_t
{
    /** Default PE Duration */
...
}  IEEEtypes_HeOpParam_t;

typedef  struct _IEEEtypes_HeBssColorInfo_t
{
    /** BSS Color */
...
}  IEEEtypes_HeBssColorInfo_t;

typedef  struct _IEEEtypes_HeMcsMap_t
{
    /** Max HE-MAC for 1 SS */
    t_u8 max_mcs_1ss: 2;
    /** Max HE-MAC for 2 SS */
    ...
    /** Max HE-MAC for 8 SS */
    t_u8 max_mcs_8ss: 2;
}  IEEEtypes_HeMcsMap_t, *pIEEEtypes_HeMcsMap_t;

typedef  struct _IEEEtypes_HeOp_t
{
    /** Generic IE header */
    IEEEtypes_Header_t ieee_hdr;
    /** Element id extension */
...
*/
#if CONFIG_11K
typedef  struct _IEEEtypes_RrmEnabledCapabilities_t
{
    /* First byte */
    t_u8 LinkMeas : 1;
    t_u8 NborRpt : 1;
    ...
    t_u8 Reserved : 4;
}  IEEEtypes_RrmEnabledCapabilities_t, *pIEEEtypes_RrmEnabledCapabilities_t;

typedef  struct _IEEEtypes_RrmElement_t
{
    /** Element ID */
    t_u8 element_id;
    /** Length */
...
}  IEEEtypes_RrmElement_t, *pIEEEtypes_RrmElement_t;

/** Mobility Domain element */
typedef  struct _MrvlIETypes_MobDomain_t
{
    /** Header */
    ...
    t_u8 ft_cap_policy;
}  MrvlIETypes_MobDomain_t;

typedef  enum _IEEEtypes_RRM_ActionFieldType_e
{
...
}  IEEEtypes_RRM_ActionFieldType_e;
#endif
...
#endif
#ifndef MLAN_WMSDK_MAX_WPA_IE_LEN
    #define MLAN_WMSDK_MAX_WPA_IE_LEN 64U
#endif
#ifndef MLAN_MAX_MDIE_LEN
    #define MLAN_MAX_MDIE_LEN         10U
#endif
#ifndef MLAN_MAX_VENDOR_IE_LEN
