...
typedef MLAN_PACK_START struct _wlan_802_11_header
{
    ...
    t_u16 duration_id;
    /** Address1 */
    mlan_802_11_mac_addr addr1;//6
    /** Address2 */
    mlan_802_11_mac_addr addr2;//6
    /** Address3 */
    mlan_802_11_mac_addr addr3;//6
    /** Sequence Control */
    t_u16 seq_ctl;
    /** Address4 */
